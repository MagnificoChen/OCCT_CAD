...
class QOccVtkSelPipeline;
DEFINE_STANDARD_HANDLE(QOccVtkSelPipeline, Standard_Transient)

/**
 * @class QOccVtkSelPipeline
 * @brief Manages the selection and highlighting pipeline for a VTK actor.
 *
 * The QOccVtkSelPipeline class handles the setup and management of the VTK pipeline
 ...
 */
class QOccVtkSelPipeline : public Standard_Transient
{
public:
    /**
     * @brief Provides run-time type information for QIVtkSelectionPipeline.
     */
    DEFINE_STANDARD_RTTIEXT(QOccVtkSelPipeline, Standard_Transient)
...
private:
    //used for update shape information
