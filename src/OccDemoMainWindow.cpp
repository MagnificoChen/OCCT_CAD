...
#include "src/Dialog/DialogFeatureBoolSubtract.h"
#include "src/Dialog/DialogFeatureBoolCombine.h"
...
void OccDemoMainWindow::_initializeRibbonBarButtons() {
    ...
    pAction = new QAction(this);
    pAction->setText("Subtract");
    pAction->setIcon(QIcon(":/image/resource/subtract.png"));
    pAction->setObjectName("actOpenDlgSubtract");
    panel_basic->addLargeAction(pAction);
    connect(pAction, &QAction::triggered, this, &OccDemoMainWindow::OnOpenSubtractDialog);

    pAction = new QAction(this);
    pAction->setText("Combine");
    pAction->setIcon(QIcon(":/image/resource/combine.png"));
    pAction->setObjectName("actOpenDlgCombine");
    panel_basic->addLargeAction(pAction);
    connect(pAction, &QAction::triggered, this, &OccDemoMainWindow::OnOpenCombineDialog);
...
void OccDemoMainWindow::OnOpenSubtractDialog() {
    auto dialog = new DialogFeatureBoolSubtract(this);
    m_dialogManager->OpenDialog(dialog);
}

void OccDemoMainWindow::OnOpenCombineDialog() {
    auto dialog = new DialogFeatureBoolCombine(this);
    m_dialogManager->OpenDialog(dialog);
}
