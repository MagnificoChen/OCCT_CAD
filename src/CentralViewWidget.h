...
#include "src/Render/QOCCVTKIStyle.h"
...
public slots:
    ...
    // Getters and setters
public:
    [[nodiscard]] vtkSmartPointer<QOCCVTKIStyle> getPickInteractorStyle() const
    {
...
private:
    ...
    vtkSmartPointer<QOCCVTKIStyle> m_pickInteractorStyle;
